...
class WelcomePage : public klay::Layout, public klay::NaviItemEventListener {
public:
...
class SecuritySetupPage : public klay::Layout, public klay::NaviItemEventListener {
public:
...
class PasswordSetupPage : public klay::Layout, public klay::NaviItemEventListener {
public:
