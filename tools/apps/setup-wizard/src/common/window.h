...
public:
	...
	virtual void addSignalHandler(const std::string& emission, const std::string& source, SignalHandler&& handler);
	virtual void removeSignalHandler(const std::string& emission, const std::string& source);
